...
int stringCompression(vector<char>& chars) {
    int i = 0;                // Pointer for reading the characters
    int ansIndex = 0;         // Pointer for writing the compressed characters
    int n = chars.size();

    while (i < n) {
        int j = i + 1;        // Find the next different character
...
int main() {
    ...
    // Print the compressed array and its new length
